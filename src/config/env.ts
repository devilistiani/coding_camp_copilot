...
const envSchema = z.object({
  ...
  JWT_ACCESS_SECRET: z.string().min(32, 'JWT_ACCESS_SECRET harus minimal 32 karakter'),
  JWT_REFRESH_SECRET: z.string().min(32, 'JWT_REFRESH_SECRET harus minimal 32 karakter'),
